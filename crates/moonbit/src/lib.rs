...
use wit_bindgen_core::{
    ...
    wit_parser::{
        ...
        LiftLowerAbi, ManglingAndAbi, Record, Resolve, ResourceIntrinsic, Result_, SizeAlign,
        Tuple, Type, TypeId, Variant, WasmExport, WasmExportKind, WasmImport, WorldId, WorldKey,
    },
};
