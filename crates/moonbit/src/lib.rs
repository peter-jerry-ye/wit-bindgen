...
impl WorldGenerator for MoonBit {
    ...
    fn finish(&mut self, resolve: &Resolve, id: WorldId, files: &mut Files) -> Result<()> {
        ...
        if let Some(imports) = self.pkg_resolver.package_import.get(&self.opts.gen_dir) {
            let mut deps = imports
                .packages
                .iter()
                .map(|(k, v)| {
...
impl InterfaceGenerator<'_> {
    ...
    fn import(&mut self, module: Option<&WorldKey>, func: &Function) {
        ...
        let mbt_sig = self.gen.pkg_resolver.mbt_sig(self.name, func, false);
    ...
    fn generate_async_import_function(
            ...
            match &func.params[..] {
                ...
                multiple_params => {
                    ...
                    body.push_str(&format!(
                        ...
                        ffi = self.gen.pkg_resolver.qualify_package(self.name, FFI_DIR)
                    ));
        ...
        let ffi = self.gen.pkg_resolver.qualify_package(self.name, FFI_DIR);
    ...
    fn type_resource(&mut self, _id: TypeId, name: &str, docs: &Docs) {
        ...
        if self.direction == Direction::Import {
            ...
            uwrite!(
                ...
                "#,
                gen.gen.pkg_resolver.qualify_package(gen.name, self.name)
            );
    ...
    fn emit(
        ...
        match inst {
            ...
            Instruction::I32FromS8 => {
                self.gen.ffi_imports.insert(ffi::EXTEND8);
            ...
            Instruction::I32FromS16 => {
                self.gen.ffi_imports.insert(ffi::EXTEND16);
            ...
            Instruction::ListCanonLower { element, realloc } => match element {
                Type::U8 => {
                    ...
                    self.gen.ffi_imports.insert(ffi::BYTES2PTR);
                    uwriteln!(
                        self.src,
                        "
                ...
                Type::U32 | Type::U64 | Type::S32 | Type::S64 | Type::F32 | Type::F64 => {
                    ...
                    let ty = match element {
                        Type::U32 => {
                            self.gen.ffi_imports.insert(ffi::UINT_ARRAY2PTR);
                            "uint"
                        }
                        Type::U64 => {
                            self.gen.ffi_imports.insert(ffi::UINT64_ARRAY2PTR);
                            "uint64"
                        }
                        Type::S32 => {
                            self.gen.ffi_imports.insert(ffi::INT_ARRAY2PTR);
                            "int"
                        }
                        Type::S64 => {
                            self.gen.ffi_imports.insert(ffi::INT64_ARRAY2PTR);
                            "int64"
                        }
                        Type::F32 => {
                            self.gen.ffi_imports.insert(ffi::FLOAT_ARRAY2PTR);
                            "float"
                        }
                        Type::F64 => {
                            self.gen.ffi_imports.insert(ffi::DOUBLE_ARRAY2PTR);
                            "double"
                        }
                        _ => unreachable!(),
                    };
            ...
            Instruction::ListCanonLift { element, .. } => match element {
                Type::U8 => {
                    ...
                    self.gen.ffi_imports.insert(ffi::PTR2BYTES);
                    uwrite!(
                        self.src,
                        "
                ...
                Type::U32 | Type::U64 | Type::S32 | Type::S64 | Type::F32 | Type::F64 => {
                    let ty = match element {
                        Type::U32 => {
                            self.gen.ffi_imports.insert(ffi::PTR2UINT_ARRAY);
                            "uint"
                        }
                        Type::U64 => {
                            self.gen.ffi_imports.insert(ffi::PTR2UINT64_ARRAY);
                            "uint64"
                        }
                        Type::S32 => {
                            self.gen.ffi_imports.insert(ffi::PTR2INT_ARRAY);
                            "int"
                        }
                        Type::S64 => {
                            self.gen.ffi_imports.insert(ffi::PTR2INT64_ARRAY);
                            "int64"
                        }
                        Type::F32 => {
                            self.gen.ffi_imports.insert(ffi::PTR2FLOAT_ARRAY);
                            "float"
                        }
                        Type::F64 => {
                            self.gen.ffi_imports.insert(ffi::PTR2DOUBLE_ARRAY);
                            "double"
                        }
                        _ => unreachable!(),
                    };
            ...
            Instruction::StringLower { realloc } => {
                ...
                self.gen.ffi_imports.insert(ffi::STR2PTR);
                uwrite!(
                    self.src,
                    "
            ...
            Instruction::StringLift { .. } => {
                ...
                self.gen.ffi_imports.insert(ffi::PTR2STR);
                uwrite!(
                    self.src,
                    "
            ...
            Instruction::ListLift { element, .. } => {
                ...
                self.gen.ffi_imports.insert(ffi::FREE);
                uwrite!(
                    self.src,
                    "
                    let {array} : Array[{ty}] = [];
            ...
            Instruction::CallInterface { func, async_ } => {
                ...
                if *async_ {
                    ...
                    let ffi = self
                        ...
                        .gen
                        .pkg_resolver
                        .qualify_package(self.gen.name, FFI_DIR);
                    uwrite!(
                        self.src,
                        r#"
                        let task = {ffi}current_task();
            ...
            | Instruction::LengthLoad { offset } => {
                self.gen.ffi_imports.insert(ffi::LOAD32);
                results.push(format!(
            ...
            Instruction::I32Load8U { offset } => {
                self.gen.ffi_imports.insert(ffi::LOAD8_U);
                results.push(format!(
            ...
            Instruction::I32Load8S { offset } => {
                self.gen.ffi_imports.insert(ffi::LOAD8);
                results.push(format!(
            ...
            Instruction::I32Load16U { offset } => {
                self.gen.ffi_imports.insert(ffi::LOAD16_U);
                results.push(format!(
            ...
            Instruction::I32Load16S { offset } => {
                self.gen.ffi_imports.insert(ffi::LOAD16);
                results.push(format!(
            ...
            Instruction::I64Load { offset } => {
                self.gen.ffi_imports.insert(ffi::LOAD64);
                results.push(format!(
            ...
            Instruction::F32Load { offset } => {
                self.gen.ffi_imports.insert(ffi::LOADF32);
                results.push(format!(
            ...
            Instruction::F64Load { offset } => {
                self.gen.ffi_imports.insert(ffi::LOADF64);
                results.push(format!(
            ...
            | Instruction::LengthStore { offset } => {
                self.gen.ffi_imports.insert(ffi::STORE32);
                uwriteln!(
                    self.src,
            ...
            Instruction::I32Store8 { offset } => {
                self.gen.ffi_imports.insert(ffi::STORE8);
                uwriteln!(
                    self.src,
            ...
            Instruction::I32Store16 { offset } => {
                self.gen.ffi_imports.insert(ffi::STORE16);
                uwriteln!(
                    self.src,
            ...
            Instruction::I64Store { offset } => {
                self.gen.ffi_imports.insert(ffi::STORE64);
                uwriteln!(
                    self.src,
            ...
            Instruction::F32Store { offset } => {
                self.gen.ffi_imports.insert(ffi::STOREF32);
                uwriteln!(
                    self.src,
            ...
            Instruction::F64Store { offset } => {
                self.gen.ffi_imports.insert(ffi::STOREF64);
                uwriteln!(
                    self.src,
